...
def _():
    ...
    # it will be string event the user input a number
    return cost, tax
...
@app.cell
def _():
    freight_charges = [16.75, 22.25, 25.00, 16.75, 22.25, 25.00]
    #counting from 0. If backword, counting from -1
    # if you want a slice 0-3. It will be 0, 1, 2. 3 will not be included
...
def _(freight_charges):
    ...
    for chargesss in freight_charges:
        if chargesss < 25:
            charge_25_less.append(chargesss)
    print(charge_25_less)
    return
